...
(function () {
  ...
  var FEATURES = [
    ...
    { key:'tool:project-update', name:'Project Update', since:'2026-07-29', tier:'tooway', group:'Site intelligence',
      what:'The rollout figures.' },
    { key:'tool:team', name:'Team Directory', since:'2026-08-27', tier:'tooway', group:'People & work',
      what:'Names, mobiles, NIC numbers and vehicles. Opening it lets the team read and copy; adding and removing stays mine.' },
    { key:'tool:field-config', name:'Field Config', since:'2026-08-27', tier:'tooway', group:'Field operations',
    ...
    { key:'tool:site-access', name:'Site Access Lookup', since:'2026-07-26', tier:'tooway', group:'Site intelligence',
      what:'The site list – depot, contact, permissions.' },
    { key:'tool:site-data', name:'Site Data Lookup', since:'2026-07-26', tier:'tooway', group:'Site intelligence',
